...
public class CustomerSettingsAcitivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void saveUserInformation(){
        ...
        if(resultUri != null) {
            ...
            Toast.makeText(CustomerSettingsAcitivity.this, "Please select a profile image.", Toast.LENGTH_SHORT).show();
            return;
        }
